...
<html>
 <head>
        ...
        <title>Add Events with Items</title>
...
.button {
  ...
  <div class="info">
   ...
   <form method="post" action="AddItemsServlet" onsubmit="return validate();">
    <h2>ADD EVENTS</h2>
    <ul class="noBullet">
      <li>
			...
			<tr>
				...
				<td><input type="checkbox" name="dj" value="dj">DJ</td>
			</tr>
			
			<tr>
				<td></td>
				<td><input type="checkbox" name="cake" value="cake" checked> CAKE</td>
			</tr>
				
				<tr>
				<td></td>
			<td><input type="checkbox" name="flower" value="flower" checked> Flower Decorating</td>
			</tr>
    ...
    <script src="js/index.js"></script>
            ...
            <center>
                ...
                <%
                    ...
                    {
                        out.println(request.getAttribute("InsertErrorMsg")); //get erro message
                    }
                %>
                </h3>
             
                
                <a href="Item.jsp" class="button">Event List</a>
