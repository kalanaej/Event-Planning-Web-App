...
<html>
    <head>
        ...
        <title>Edit Events with Package</title>
      ...
      <link rel="stylesheet" href="css/style99.css">
        ...
        function validate()
        {
            ...
            if(!name_pattern.test(name.value) || name.value=='') //check if condition 
            {
  ...
  <div class="info">
   ...
   <form method="post" action="EditServlet" onsubmit="return validate();">
    <ul class="noBullet">
      <li>
        <div class="main">
            <center>
             <h1>Update Event</h1>
              ...
              <table>         
            <%
            if(request.getParameter("edit_id")!=null) //get edit_id from index.jsp 
            {
                ...
                try
                {
	             ...
	             PreparedStatement pstmt=null; //create statement
                    ...
                    pstmt=con.prepareStatement("select * from events where eventID=?"); //sql select query 
                    pstmt.setInt(1,id);
            ...
            <center>
                <h3 style="color:red;">
                    <% 
                        ...
                        {
                            out.print(request.getAttribute("UpdateErrorMsg")); //get update record fail error message from EditServlet
                    }
                    %>
                </h3>
