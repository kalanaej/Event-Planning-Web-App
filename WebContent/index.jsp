			...
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-110">
					<table data-vertable="ver1">
						<thead>
						 ...
						 <h1><a href="Add.jsp">Add Events</a></h1> 
                ...
                try
                {
	             ...
	             PreparedStatement pstmt=null; //create statement
                    ...
                    pstmt=con.prepareStatement("select * from events"); //sql select query
                    ResultSet rs=pstmt.executeQuery(); //execute query and set in Result
                ...
                <tr>
                   ...
                   <td><div align="center"><%=rs.getString("eventID")%></div></td>
                    ...
                    <td><a href="trialedit.jsp?edit_id=<%=rs.getInt("eventID")%>">Edit</a></td>
                    <td><a href="Delete.jsp?delete_id=<%=rs.getInt("eventID")%>">Delete</a></td>
